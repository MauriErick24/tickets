      ...
      <div className="bus-seats">
        ...
        <div className="seat-row">
          ...
          <input
            ...
            disabled
          />
          <label htmlFor="seat19" className="seat reserved">
            19
          </label>
